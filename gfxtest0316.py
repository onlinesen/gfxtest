...
class GFXTest():
    ...
    def gettk(self):
        ...
        menubar.add_command(label="截图 〼 |", command=self.crop_image)
        ...
        onekey_menu.add_command(label="连接wifi", command=self.enable_wifi)
    ...
    def testFPS(self):
        try:
            ...
            self.textout.insert(END, "包名: " + self.package + "_" + self.apkversion + "_" + str(
                self.targetSDK) + "\n")
            ...
            if self.scroll_xy == "m" or self.scroll_xy == "p" or self.scroll_xy == "pa":
                if self.scroll_xy == "p":
                    ...
                    for i in xrange(1, int(self.screensave) + 1):
                        ...
                        #     # self.textout.update()
                        self.screenShot(
                            os.getcwd() + "/pic/" + self.package + str(
                                datetime.datetime.now().strftime("%m_%d_%H_%M_%S")) + ".png")
                elif self.scroll_xy == "m":
            ...
            if self._mouse_motion == "click":
                ...
                if len(self._mouse_motion_xy) > 3:
                    ...
                    if self._mouse_motion_crop == "crop":
                        ...
                        c.create_rectangle(self._mouse_motion_xy[0][0], self._mouse_motion_xy[0][1],
