...
class CTSTest(unittest.TestCase):
    ...
    def miniscreenShot(self):
        try:
            params = '{x}x{y}@{x1}x{y1}/{r}'.format(x=self.wmsize[0], y=self.wmsize[1], x1=self.wmsize[0], y1=self.wmsize[1], r=0)
    ...
    def setpassword(self, method, pwd):  # 1111
    ...
    def test_AdminInsatll(self):  # 8.1 tcs

        print "test_AdminInsatll"
        cmds = ['adb', '-s', self.serial, 'install', '-r -t ',
                os.getcwd() + r"/android-cts-verifier_8.1/CtsEmptyDeviceAdmin.apk"]
    ...
    def test_BYODManaged(self):
        ...
        #     time.sleep(2)
        #     getORno = self.findImage("bag.png")
        #     time.sleep(1)
        #     self.back2Verify()
        #     if getORno!=None:
        #         self.d(text="PASS").click()
        ...
        #     time.sleep(2)
        #
        #     getORno2 = self.findImage("work.png")
        #     time.sleep(1)
        #     self.d.press.back()
        #     if getORno2!=None:
        #         self.d(text="PASS").click()
        ...
        #     time.sleep(2)
        #
        #     getORno3 = self.findImage("status.png")
        #     time.sleep(1)
        ...
        #         time.sleep(0.5)
        #         self.raw_cmd('shell', 'input', 'keyevent', '66')
        #     getORno4 = self.findImage("tost.png")
        #     time.sleep(1)
        #     self.d(text="FINISH").click()
        #     if getORno4[0]!=None:
        #         if getORno4.matched:
        ...
        #     time.sleep(1)
        #     getORno = self.findImage("DeviceAdminApp_VBbag1.720x1440.png")
        #     self.d.click(int(getORno[0]), int(getORno[1]))
        #     result = self.d(text="Remove work profile").exists
        #     self.d.press.back()
        #     self.d.press.back()
        #     self.d.press.back()
        #
        ...
        #     self.d(text="GO").click()
        #     time.sleep(1)
        #     result = (("SWITCH TO PERSONAL") in self.d.dump()) & ("CTS Verifier" in self.d.dump())
        #     self.d.press.back()
        #     if result:
        #         self.d(text="PASS").click()
        #         time.sleep(1)
        ...
        #             self.press_pass()
            ...
            #
            # cmds = ['adb', '-s', self.serial, 'install', '-r -t',
            #         os.getcwd() + r"/android-cts-verifier_8.1/CtsVpnFirewallAppApi23.apk"]
            # subprocess.Popen(cmds, stdout=subprocess.PIPE, stderr=subprocess.PIPE).communicate()[0]
            #
            # time.sleep(1)
            ...
            # cmds = ['adb', '-s', self.serial, 'install', '-r -t',
            #         os.getcwd() + r"/android-cts-verifier_8.1/CtsVpnFirewallAppApi24.apk"]
            # subprocess.Popen(cmds, stdout=subprocess.PIPE, stderr=subprocess.PIPE).communicate()[0]
            # time.sleep(1)
            # self.d(text="GO").click()
            # time.sleep(1)
            ...
            # getORno3 = self.findImage("status_off.png")
            # time.sleep(1)
            # if getORno3[0]!=None:
            #     self.d(text="PASS").click()
            #     time.sleep(1)
            ...
            # self.d.swipe(400, 800, 400, 100, steps=20)
            # time.sleep(1)
            # getORno4 = self.findImage("verify_off.png")
            # if getORno4[0]!=None:
    ...
    def test_BYOD_Provisioning(self):
        ...
        if self.d(text="DELETE").exists:
            self.d(text="DELETE").click()
        self.d(text="ACCEPT & CONTINUE").click()
        fi = self.findImage("verify_icon.720x1440.png")
        if fi!=None:
                self.press_pass()
        else:
                self.press_pass(tof=False)
    ...
    def test_DeviceOwneTest(self):
        try:
            ...
            # result =(self.findImage("Actionnotallowed.720x1440.png") != None)
            #
            # self.d.press.back()
            # self.d.press.back()
            # self.d.press.back()
...
if __name__ == '__main__':
   ...
   # runner.findImage("verify_icon.720x1440.png")
